...
|---|---|---|---|
| **[Australian Retail Intelligence](https://github.com/Tauseef-hub/Australian-retail-intelligence)** | End-to-end forecasting platform on 42 years of ABS retail data — ETL, 192 Prophet models, FastAPI, Power BI | 342,747 raw → 93,578 clean records at initial load (now 95K+ and growing — see badge above); 2,304 forecasts at <10% avg MAPE | [Live API](https://australian-retail-intelligence-1.onrender.com) · [Docs](https://australian-retail-intelligence-1.onrender.com/docs) |
